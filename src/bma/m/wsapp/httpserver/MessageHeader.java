...
public class MessageHeader {
	...
	/**
	 * return an Iterator that returns all values of a particular key in
	 * sequence
	 */
	...
	public synchronized Map<String, List> getHeaders() {
		return getHeaders(null);
	}

	public synchronized Map<String, List> getHeaders(String[] excludeList) {
	...
	/**
	 * Remove the key from the header. If there are multiple values under the
	 * same key, they are all removed. Nothing is done if the key doesn't exist.
