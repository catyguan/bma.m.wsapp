...
public class HttpPrincipal implements Principal {
	...
	/**
	 * Compares two HttpPrincipal. Returns <code>true</code> if <i>another</i>
	 * is an instance of HttpPrincipal, and its username and realm are equal to
	 * this object's username and realm. Returns <code>false</code> otherwise.
	 */
	public boolean equals(Object another) {
		...
		return (username.equals(theother.username) && realm
				.equals(theother.realm));
	}

	/**
	 * returns the contents of this principal in the form <i>realm:username</i>
	 */
	...
	/**
	 * returns a hashcode for this HttpPrincipal. This is calculated as
	 * <code>(getUsername()+getRealm().hashCode()</code>
	 */
	public int hashCode() {
